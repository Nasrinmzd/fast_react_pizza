    ...
    <div className="px-4 py-6 ">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-center">
          ...
          {formErrors?.phone && <p className="text-xs mt-2 text-red-700 bg-red-100 p-1.5 rounded-md">{formErrors.phone}</p>}
          </div>
        </div>
        ...
        <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-center relative">
          ...
          <div className="grow">
            ...
            {addressStatus === "error" && <p className="text-xs mt-2 text-red-700 bg-red-100 p-1.5 rounded-md">{errorAddress}</p>}
          </div>
